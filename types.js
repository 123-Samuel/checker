 ...
 * @property {Message} editedMessage - Message edit notification for known messages.
 * @property {Message} channelPost - New incoming channel post of any kind - text, photo, sticker, etc.
 * @property {Message} editedChannelPost - Channel post edit notification for known posts.
 * @property {MessageReactionUpdated} messageReaction - User changed a message reaction; requires bot as admin.
 * @property {MessageReactionCountUpdated} messageReactionCount - Grouped anonymous message reaction changes.
 * @property {InlineQuery} inlineQuery - New incoming inline query
 * @property {ChosenInlineResult} chosenInlineResult - User's choice from an inline query sent to chat.
 * @property {CallbackQuery} callbackQuery - New incoming callback query
 * @property {ShippingQuery} shippingQuery - New incoming shipping query. Only for invoices with flexible price
 * @property {PreCheckoutQuery} preCheckoutQuery - New incoming pre-checkout query. Contains full information about checkout.
 * @property {Poll} poll - Notification of new poll state; for stopped polls and those sent by the bot.
 * @property {PollAnswer} pollAnswer - User changed their vote in a non-anonymous poll sent by the bot.
 * @property {ChatMemberUpdated} myChatMember - Bot's chat member status updated in a chat.
 * @property {ChatMemberUpdated} chatMember - Chat member's status updated; requires bot admin.
 * @property {ChatJoinRequest} chatJoinRequest - Chat join request sent; requires bot's `can_invite_users` right.
 * @property {ChatBoostUpdated} chatBoost - Chat boost added or changed; requires bot admin.
 * @property {ChatBoostRemoved} removedChatBoost - Chat boost removed; requires bot admin.
 * 
 * @property {function(): Chat} chat - chat.
 * @property {function(): User} from - user or bot.
 ...
 *
 * @property {function(`sheetName`):SheetOperations} sheet - Method to access sheet operations by sheet name.
 *
 * @property {function(chatId, text, SendMessageOptions): Message} sendMessage - send text messages.
 * @property {function(chatId, fromChatId, messageId, ForwardMessageOptions): Message} forwardMessage - forward messages of any kind.
 * @property {function(chatId, fromChatId, messageIds, ForwardMessagesOptions): MessageId[]} forwardMessages - forward multiple messages of any kind.
 * @property {function(chatId, fromChatId, messageId, CopyMessageOptions): MessageId} copyMessage - copy messages of any kind.
 * @property {function(chatId, fromChatId, messageIds, CopyMessagesOptions): MessageId[]} copyMessages - Copies messages of any kind.
 * @property {function(chatId, photo, SendPhotoOptions): Message} sendPhoto - Sends photos.
 * @property {function(chatId, audio, SendAudioOptions): Message} sendAudio - Sends an audio file.
 * @property {function(chatId, document, SendDocumentOptions): Message} sendDocument - Sends a general file.
 * @property {function(chatId, video, SendVideoOptions): Message} sendVideo - Sends a video file.
 * @property {function(chatId, animation,SendAnimationOptions): Message} sendAnimation - Sends an animation file.
 * @property {function(chatId, voice,SendVoiceOptions): Message} sendVoice - Sends an audio file as a voice message.
 * @property {function(chatId, videoNote,SendVideoNoteOptions): Message} sendVideoNote - Sends a video message.
 * @property {function(chatId, InputMediaAudio[]|InputMediaDocument[]|InputMediaPhoto[]|InputMediaVideo[],SendMediaGroupOptions): Message[]} sendMediaGroup - Sends a group of photos, videos, documents or audios as an album.
 * @property {function(chatId, latitude, longitude, SendLocationOptions): Message} sendLocation - Sends point on the map.
 * @property {function(chatId, latitude, longitude, title, address, SendVenueOptions): Message} sendVenue - Sends information about a venue.
 * @property {function(chatId, phoneNumber, firstName,SendContactOptions): Message} sendContact - Sends phone contacts.
 * @property {function(chatId, question, options,SendPollOptions): Message} sendPoll - Sends a native poll.
 * @property {function(chatId,SendDiceOptions): Message} sendDice - Sends an animated emoji that will display a random value.
 * @property {function(chatId, action,SendChatActionOptions): boolean} sendChatAction - Tells the user that something is happening on the bot's side.
 * @property {function(chatId, messageId, SetMessageReactionOptions): boolean} setMessageReaction - Changes the chosen reactions on a message.
 * @property {function(userId,GetUserProfilePhotosOptions): UserProfilePhotos} getUserProfilePhotos - Gets a list of profile pictures for a user.
 * @property {function(fileId): File} getFile - Gets basic information about a file.
 * @property {function(chatId, userId,BanChatMemberOptions): boolean} banChatMember - Bans a user in a group, supergroup, or channel.
 * @property {function(chatId, userId,UnbanChatMemberOptions): boolean} unbanChatMember - Unbans a previously banned user in a supergroup or channel.
 * @property {function(chatId, userId,ChatPermissions,RestrictChatMemberOptions): boolean} restrictChatMember - Restricts a user in a supergroup.
 * @property {function(chatId, userId, PromoteChatMemberOptions): boolean} promoteChatMember - Promotes or demotes a user in a supergroup or channel.
 * @property {function(chatId, userId, title): boolean} setChatAdministratorCustomTitle - Sets a custom title for an administrator in a supergroup.
 * @property {function(chatId, senderChatId): boolean} banChatSenderChat - Bans a channel chat in a supergroup or channel.
 * @property {function(chatId, senderChatId): boolean} unbanChatSenderChat - Unbans a previously banned channel chat.
 * @property {function(chatId, ChatPermissions,SetChatPermissionsOptions): boolean} setChatPermissions - Sets default chat permissions for all members.
 * @property {function(chatId): string} exportChatInviteLink - Generates a new primary invite link for a chat.
 * @property {function(chatId,CreateChatInviteLinkOptions): ChatInviteLink} createChatInviteLink - Creates an additional invite link for a chat.
 * @property {function(chatId, inviteLink,EditChatInviteLinkOptions): ChatInviteLink} editChatInviteLink - Edits a non-primary invite link created by the bot.
 * @property {function(chatId, inviteLink): ChatInviteLink} revokeChatInviteLink - Revokes an invite link created by the bot.
 * @property {function(chatId, userId): object} approveChatJoinRequest - Approves a chat join request.
 * @property {function(chatId, userId): object} declineChatJoinRequest - Declines a chat join request.
 * @property {function(chatId, photo): object} setChatPhoto - Sets a new chat photo.
 * @property {function(chatId): object} deleteChatPhoto - Deletes the chat photo.
 * @property {function(chatId, title): Object} setChatTitle - Changes the title of a chat.
 * @property {function(chatId, description): Object} setChatDescription - Changes the description of a chat.
 * @property {function(chatId, messageId,PinChatMessageOptions): Object} pinChatMessage - Pins a message in a chat.
 * @property {function(chatId, UnpinChatMessageOptions): Object} unpinChatMessage - Removes a message from the list of pinned messages in a chat.
 * @property {function(chatId): Object} unpinAllChatMessages - Clears the list of pinned messages in a chat.
 * @property {function(chatId): Object} leaveChat - Bot leaves a group, supergroup, or channel.
 * @property {function(chatId): Chat} getChat - Gets information about the chat.
 * @property {function(chatId): ChatMember[]} getChatAdministrators - Gets a list of administrators in a chat.
 * @property {function(chatId): number} getChatMemberCount - Gets the number of members in a chat.
 * @property {function(chatId, userId): ChatMember} getChatMember - Gets information about a member of a chat.
 * @property {function(chatId, setName): boolean} setChatStickerSet - Sets a new group sticker set for a supergroup.
 * @property {function(chatId): boolean} deleteChatStickerSet - Deletes a group sticker set from a supergroup.
 * @property {function(): Sticker[]} getForumTopicIconStickers - Gets custom emoji stickers for forum topic icons.
 * @property {function(chatId, name, CreateForumTopicOptions): ForumTopic} createForumTopic - Creates a topic in a forum supergroup chat.
 * @property {function(chatId, messageThreadId, EditForumTopicOptions): boolean} editForumTopic - Edits name and icon of a forum topic.
 * @property {function(chatId, messageThreadId): boolean} closeForumTopic - Closes an open topic in a forum supergroup chat.
 * @property {function(chatId, messageThreadId): boolean} reopenForumTopic - Reopens a closed topic in a forum supergroup chat.
 * @property {function(chatId, messageThreadId): boolean} deleteForumTopic - Deletes a forum topic along with all its messages in a forum supergroup chat.
 * @property {function(chatId, messageThreadId): boolean} unpinAllForumTopicMessages - Clears the list of pinned messages in a forum topic.
 * @property {function(chatId, name): boolean} editGeneralForumTopic - Edits the name of the 'General' topic in a forum supergroup chat.
 * @property {function(chatId): Object} closeGeneralForumTopic - Closes an open 'General' topic in a forum supergroup chat.
 * @property {function(chatId): Object} reopenGeneralForumTopic - Reopens a closed 'General' topic in a forum supergroup chat.
 * @property {function(chatId): Object} hideGeneralForumTopic - Hides the 'General' topic in a forum supergroup chat.
 * @property {function(chatId): Object} unhideGeneralForumTopic - Unhides the 'General' topic in a forum supergroup chat.
 * @property {function(chatId): boolean} unpinAllGeneralForumTopicMessages - Clears the list of pinned messages in a General forum topic.
 * @property {function(callbackQueryId): boolean} answerCallbackQuery - Sends answers to callback queries sent from inline keyboards.
 * @property {function(chatId, userId): UserChatBoosts} getUserChatBoosts - Gets the list of boosts added to a chat by a user.
 * @property {function(commands): boolean} setMyCommands - Changes the list of the bot's commands.
 ...
 * @property {function(text,EditMessageTextOptions): Message} editMessageText - Edits text and game messages.
 * @property {function(EditMessageCaptionOptions): Message} editMessageCaption - Edits captions of messages.
 * @property {function(media,EditMessageMediaOptions): Message} editMessageMedia - Edits animation, audio, document, photo or video messages.
 * @property {function(latitude, longitude, EditMessageLiveLocationOptions): Message} editMessageLiveLocation - Edits live location messages.
 ...
 * @property {function(chatId, messageId,StopPollOptions): Poll} stopPoll - Stops a poll.
 * @property {function(chatId, messageId): boolean} deleteMessage - Deletes a message.
 * @property {function(chatId, messageIds): object} deleteMessages - Deletes multiple messages.
 * @property {function(chatId, sticker,SendStickerOptions): Message} sendSticker - Sends a sticker.
 * @property {function(name): StickerSet} getStickerSet - Gets a sticker set.
 * @property {function(customEmojiIds): Sticker[]} getCustomEmojiStickers - Gets information about custom emoji stickers.
 * @property {function(userId, sticker, stickerFormat): File} uploadStickerFile - Uploads a sticker file.
 * @property {function(userId, name, title, InputSticker[], CreateNewStickerSetOptions): boolean} createNewStickerSet - Creates a new sticker set.
 * @property {function(userId, name, sticker): boolean} addStickerToSet - Adds a new sticker to a set.
 * @property {function(sticker, position): boolean} setStickerPositionInSet - move a sticker in a set.
 * @property {function(sticker): boolean} deleteStickerFromSet - delete a sticker from a set.
 * @property {function(sticker, emojiList): boolean} setStickerEmojiList - change the list of emoji assigned to a regular or custom emoji sticker.
 * @property {function(sticker, SetStickerKeywordsOptions): boolean} setStickerKeywords - change search keywords assigned to a regular or custom emoji sticker.
 * @property {function(sticker,SetStickerMaskPositionOptions): boolean} setStickerMaskPosition - change the mask position of a mask sticker.
 * @property {function(name, title): boolean} setStickerSetTitle - set the title of a created sticker set.
 * @property {function(name, userId, format, SetStickerSetThumbnailOptions): boolean} setStickerSetThumbnail - set the thumbnail of a regular or mask sticker set.
 * @property {function(name,SetCustomEmojiStickerSetThumbnailOptions): boolean} setCustomEmojiStickerSetThumbnail - set the thumbnail of a custom emoji sticker set.
 * @property {function(name): boolean} deleteStickerSet - delete a sticker set.
 * @property {function(inlineQueryId, results,AnswerInlineQueryOptions): boolean} answerInlineQuery - send answers to an inline query.
 * @property {function(webAppQueryId, result): boolean} answerWebAppQuery - set the result of an interaction with a `Web App` and send a corresponding message on behalf of the user to the chat from which the query originated.
 * @property {function(chatId, providerToken, title, description, payload, currency, LabeledPrice[],SendInvoiceOptions): Message} sendInvoice - send invoices.
 * @property {function(providerToken, title, description, payload, currency, LabeledPrice[], CreateInvoiceLinkOptions): string} createInvoiceLink - create a link for an invoice.
 * @property {function(chatId, gameName,SendGameOptions): Message} sendGame - send a game.
 * @property {function(userId, score,SetGameScoreOptions): (Message | boolean)} setGameScore - set the score of the specified user in a game message.
 * @property {function(userId,GetGameHighScoresOptions): GameHighScore[]} getGameHighScores - get data for high score tables.
 * @property {function(text, ReplyOptions): Message} reply
 * @property {function(text, ReplyWithFormattedTextOptions): Message} replyWithHtml
 * @property {function(text, ReplyWithFormattedTextOptions): Message} replyWithMarkdown
 * @property {function(photoUrl|photoFileId, ReplyWithPhotoOptions): Message} replyWithPhoto - reply photo to the current chat.
 * @property {function(Action, ReplyWithChatActionOptions): boolean} replyWithChatAction - reply chat action to the current chat.
 * @property {function(text, ReplyWithEditedMessageOptions): Message} replyWithEditedMessage - reply edited message to the current chat.
 * 
 *
 * @property {TSession} tSession - Gets the temporary session object.
 * @property {TCache} tCache - Gets the temporary cache object.
 * @property {PSession} pSession - Gets the permanent session object.
 * @property {PCache} pCache - Gets the permanent cache object.
 * 
 *
 * @property {function(recipient, subject, body, options): void} sendEmail - Sends an email with optional parameters.
 *
 */
...
/**
 * Permanent Session.
 * @typedef {Object} PSession
 * @property {function(): Object} getSession - Gets the persistent session object.
 * @property {function(string): *} getValue - Gets a value from the persistent session by key.
 * @property {function(string, *): void} setValue - Sets a value in the persistent session.
 * @property {function(Object): void} setValues - Sets multiple values in the persistent session.
 * @property {function(string): void} removeValue - Removes a value from the persistent session by key.
 * @property {function(): void} delete - Deletes the persistent session.
 */


/**
 * Permanent Cache.
 * @typedef {Object} PCache
 * @property {function(string): *} getValue - Gets a value from the persistent cache by key.
 * @property {function(): Object} getCache - Gets the entire persistent cache object.
 * @property {function(string, *): void} setValue - Sets a value in the persistent cache.
 * @property {function(Object): void} setValues - Sets multiple values in the persistent cache.
 * @property {function(string): void} removeValue - Removes a value from the persistent cache by key.
 * @property {function(): void} delete - Deletes the persistent cache.
 */


/**
 * Temporary Cache.
 * @typedef {Object} TCache
 * @property {function(string): *} getValue - Gets a value from the temporary cache by key.
 * @property {function(string, *, number): void} setValue - Sets a value in the temporary cache with an optional expiry time.
 * @property {function(Array.<string>): Object} getValues - Gets multiple values from the temporary cache.
 * @property {function(Object, number): void} setValues - Sets multiple values in the temporary cache with an optional expiry time.
 * @property {function(string): void} removeValue - Removes a value from the temporary cache by key.
 * @property {function(Array.<string>): void} removeValues - Removes multiple values from the temporary cache.
 */
 ...
 * @property {function(): Object} getSession - Gets the temporary session object.
 * @property {function(string): *} getValue - Gets a value from the temporary session by key.
 * @property {function(string, *, number): void} setValue - Sets a value in the temporary session with an optional expiry time.
 * @property {function(Object, number): void} setValues - Sets multiple values in the temporary session with an optional expiry time.
 * @property {function(string): void} removeValue - Removes a value from the temporary session by key.
 * @property {function(): void} delete - Deletes the temporary session.
 * 
...
/**
 * @typedef {"typing"|"upload_photo"|"record_video"|"upload_video"|"record_voice"|"upload_document"|"choose_sticker"|"find_location"|"record_video_note"} Action
 */
 ...
 * @property {Message} [message] - Message sent by the bot with the callback button that originated the query
 ...
 * @property {Message} [pinned_message] - Specified message was pinned.
